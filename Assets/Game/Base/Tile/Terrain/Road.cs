...
namespace Weathering
{
    ...
    public class Road : StandardTile //, ILinkable
    {
        ...
        public override void OnTap() {
            ...
            //// TransportAlongRoads(items, true, 20); // 沿路运输
            //LinkUtility.CreateLinkButtons(items, this); // 连接
            //LinkUtility.CreateUnlinkButtons(items, this); // 取消连接
        ...
        //    if (invokedByTapping) {
        //        items.Add(UIItem.CreateButton($"向{directionText}运输{Localization.Ins.Val(Res.Type, Res.Value)}", action));
        //    } else {
        //        action();
        //    }
        //}
