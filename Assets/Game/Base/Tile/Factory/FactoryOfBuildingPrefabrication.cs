...
namespace Weathering
{
    ...
    public class FactoryOfBuildingPrefabrication : AbstractFactoryStatic
    {
        ...
        protected override (Type, long) In_1_Inventory => (typeof(Electricity), 1);
        protected override (Type, long) Out0 => (typeof(BuildingPrefabricationSupply), 1);
        protected override (Type, long) In_0 => (typeof(SteelIngotSupply), 5);
        protected override (Type, long) In_1 => (typeof(ConcretePowderSupply), 5);
    }
}
